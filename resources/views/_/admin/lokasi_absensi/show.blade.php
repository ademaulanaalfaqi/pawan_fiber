<x-template.admin title="Detail Lokasi">
                            ...
                            <div class="row  mt-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="" class="control-label mb-1"><strong>Radius</strong></label>
                                                <p class="form-control-static">{{$lokasiabsensi->radius}} meter</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
    ...
    <script type="module">
        ...
        var circle = L.circle([<?= $lokasiabsensi->latitude ?>, <?= $lokasiabsensi->longitude ?>], {
            color: 'red',
            fillColor: '#f03',
            fillOpacity: 0.2,
